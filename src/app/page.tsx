...
export default function Home() {
  ...
  return (
    <div>
      {/* Section 1 */}
      <div className="bg-IXBbg2 text-white h-[100vh] flex items-center relative">
        {/* Left Side Content */}
        <div className="flex flex-col justify-center items-start pl-40 space-y-16 w-[60%] mb-64">
          {/* Large Text */}
          ...
          <p className="text-black">
            Ikke karrieredag enda?
            Sjekk ut mulighetene for nettverking!
          </p>
        </div>

        {/* Right Side Image */}
        <div className="absolute right-0 flex justify-center items-center mb-60 pr-10 w-[40%] mt-10">
          <Image
