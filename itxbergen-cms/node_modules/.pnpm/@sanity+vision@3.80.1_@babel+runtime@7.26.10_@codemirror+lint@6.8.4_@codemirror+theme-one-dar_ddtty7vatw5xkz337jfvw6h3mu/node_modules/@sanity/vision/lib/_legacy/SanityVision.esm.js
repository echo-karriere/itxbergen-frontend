...
import { useState, useEffect, forwardRef, useRef, useImperativeHandle, PureComponent, createRef, Fragment, Component } from "react";
...
function ParamsEditor(props) {
  ...
  let t7;
  return $[16] !== handleChange || $[17] !== props.editorRef || $[18] !== t6 ? (t7 = /* @__PURE__ */ jsx(VisionCodeMirror, { initialValue: t6, onChange: handleChange, ref: props.editorRef }), $[16] = handleChange, $[17] = props.editorRef, $[18] = t6, $[19] = t7) : t7 = $[19], t7;
}
...
class VisionGui extends PureComponent {
...
}`), this._visionRoot = createRef(), this._operationUrlElement = createRef(), this._queryEditorContainer = createRef(), this._paramsEditorContainer = createRef(), this._customApiVersionElement = createRef(), this._editorQueryRef = createRef(), this._editorParamsRef = createRef(), this._client = props.client.withConfig({
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxs(Root, { direction: "column", height: "fill", ref: this._visionRoot, sizing: "border", overflow: "hidden", "data-testid": "vision-root", children: [
        ...
        SplitPane,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Box, { height: "stretch", flex: 1, children: /* @__PURE__ */ jsxs(SplitPane, { className: "sidebarPanes", split: "horizontal", defaultSize: narrowBreakpoint() ? paneSizeOptions.defaultSize : paneSizeOptions.minSize, size: paneSizeOptions.size, allowResize: paneSizeOptions.allowResize, minSize: narrowBreakpoint() ? paneSizeOptions.minSize : 100, maxSize: paneSizeOptions.maxSize, primary: "first", children: [
              /* @__PURE__ */ jsx(InputContainer, { display: "flex", ref: this._queryEditorContainer, "data-testid": "vision-query-editor", children: /* @__PURE__ */ jsxs(Box, { flex: 1, children: [
                ...
                /* @__PURE__ */ jsx(VisionCodeMirror, { initialValue: query, onChange: this.handleQueryChange, ref: this._editorQueryRef })
              ] }) }),
              /* @__PURE__ */ jsxs(InputContainer, { display: "flex", ref: this._paramsEditorContainer, children: [
                /* @__PURE__ */ jsxs(Card, { flex: 1, tone: hasValidParams ? "default" : "critical", "data-testid": "params-editor", children: [
                  ...
                  /* @__PURE__ */ jsx(ParamsEditor, { value: rawParams, onChange: this.handleParamsChange, editorRef: this._editorParamsRef })
                ] }),
            ...
            /* @__PURE__ */ jsxs(ResultOuterContainer, { direction: "column", "data-testid": "vision-result", children: [
