"use strict";
var jsxRuntime = require("react/jsx-runtime"), reactCompilerRuntime = require("react-compiler-runtime"), sanity = require("sanity"), ui = require("@sanity/ui"), react = require("react"), reactSplitPane = require("@rexxars/react-split-pane"), icons = require("@sanity/icons"), isHotkeyEsm = require("is-hotkey-esm"), isEqual = require("react-fast-compare"), CodeMirror = require("@uiw/react-codemirror"), autocomplete = require("@codemirror/autocomplete"), commands = require("@codemirror/commands"), langJavascript = require("@codemirror/lang-javascript"), language = require("@codemirror/language"), search = require("@codemirror/search"), view = require("@codemirror/view"), highlight = require("@lezer/highlight"), color = require("@sanity/color"), styledComponents = require("styled-components"), json2Csv = require("json-2-csv"), resizeObserver = require("@juggle/resize-observer"), JSON5 = require("json5"), debounce = require("lodash/debounce.js"), index = require("./index.js"), reactJsonInspector = require("@rexxars/react-json-inspector"), LRU = require("quick-lru"), router = require("sanity/router");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var isEqual__default = /* @__PURE__ */ _interopDefaultCompat(isEqual), CodeMirror__default = /* @__PURE__ */ _interopDefaultCompat(CodeMirror), JSON5__default = /* @__PURE__ */ _interopDefaultCompat(JSON5), debounce__default = /* @__PURE__ */ _interopDefaultCompat(debounce), LRU__default = /* @__PURE__ */ _interopDefaultCompat(LRU);
...
function ParamsEditor(props) {
  ...
  let t7;
  return $[16] !== handleChange || $[17] !== props.editorRef || $[18] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(VisionCodeMirror, { initialValue: t6, onChange: handleChange, ref: props.editorRef }), $[16] = handleChange, $[17] = props.editorRef, $[18] = t6, $[19] = t7) : t7 = $[19], t7;
}
...
class VisionGui extends react.PureComponent {
  ...
  handlePaste(evt) {
    ...
    const query = parts.query, rawParams = JSON.stringify(parts.params, null, 2);
    this._editorQueryRef.current?.resetEditorContent(query), this._editorParamsRef.current?.resetEditorContent(rawParams), this.setState((prevState) => ({
  ...
  handleListenerEvent(evt) {
    evt.type === "mutation" && this.setState(({
      listenMutations
    }) => ({
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Root, { direction: "column", height: "fill", ref: this._visionRoot, sizing: "border", overflow: "hidden", "data-testid": "vision-root", children: [
        ...
        reactSplitPane.SplitPane,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { height: "stretch", flex: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(reactSplitPane.SplitPane, { className: "sidebarPanes", split: "horizontal", defaultSize: narrowBreakpoint() ? paneSizeOptions.defaultSize : paneSizeOptions.minSize, size: paneSizeOptions.size, allowResize: paneSizeOptions.allowResize, minSize: narrowBreakpoint() ? paneSizeOptions.minSize : 100, maxSize: paneSizeOptions.maxSize, primary: "first", children: [
              /* @__PURE__ */ jsxRuntime.jsx(InputContainer, { display: "flex", ref: this._queryEditorContainer, "data-testid": "vision-query-editor", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { flex: 1, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(VisionCodeMirror, { initialValue: query, onChange: this.handleQueryChange, ref: this._editorQueryRef })
              ] }) }),
              /* @__PURE__ */ jsxRuntime.jsxs(InputContainer, { display: "flex", ref: this._paramsEditorContainer, children: [
                /* @__PURE__ */ jsxRuntime.jsxs(ui.Card, { flex: 1, tone: hasValidParams ? "default" : "critical", "data-testid": "params-editor", children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(ParamsEditor, { value: rawParams, onChange: this.handleParamsChange, editorRef: this._editorParamsRef })
                ] }),
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(ResultOuterContainer, { direction: "column", "data-testid": "vision-result", children: [
