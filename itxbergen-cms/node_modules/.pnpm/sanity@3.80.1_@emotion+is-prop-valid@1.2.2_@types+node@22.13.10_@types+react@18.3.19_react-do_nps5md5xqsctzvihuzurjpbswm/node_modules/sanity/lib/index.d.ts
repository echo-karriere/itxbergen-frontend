...
import {Locale as Locale_3} from 'date-fns'
 ...
 * @hidden
 * @beta */
export declare function BasicDocument(props: BasicDocumentProps): React.JSX.Element

/**
 * @hidden
 * @beta */
export declare interface BasicDocumentProps {
  entryPath: string
  css?: string[]
  basePath?: string
}
 ...
 * @internal
 */
declare const capabilities: readonly ['globalUserMenu', 'globalWorkspaceControl']
 ...
 * @internal
 */
export declare const formatRelativeLocale: (
  date: number | Date,
...
/** @internal */
export declare interface StartInCreateBannerProps {
  documentId: string
