...
import { LOADER_QUERY_GC_INTERVAL, API_VERSION, MIN_LOADER_QUERY_LISTEN_HEARTBEAT_INTERVAL } from "./presentation.esm.js";
...
function LiveQueries(props) {
  ...
  let t8;
  return $[20] !== client || $[21] !== comlink || $[22] !== dataset || $[23] !== liveDocument || $[24] !== liveEvents.messages || $[25] !== liveEvents.resets || $[26] !== projectId || $[27] !== t7 ? (t8 = /* @__PURE__ */ jsx(Fragment, { children: t7.map((t9) => {
    const [key, t10] = t9, {
      query,
      params,
      perspective
  ...
  }) }), $[20] = client, $[21] = comlink, $[22] = dataset, $[23] = liveDocument, $[24] = liveEvents.messages, $[25] = liveEvents.resets, $[26] = projectId, $[27] = t7, $[28] = t8) : t8 = $[28], t8;
}
function _temp() {
}
...
//# sourceMappingURL=LiveQueries.esm.js.map
