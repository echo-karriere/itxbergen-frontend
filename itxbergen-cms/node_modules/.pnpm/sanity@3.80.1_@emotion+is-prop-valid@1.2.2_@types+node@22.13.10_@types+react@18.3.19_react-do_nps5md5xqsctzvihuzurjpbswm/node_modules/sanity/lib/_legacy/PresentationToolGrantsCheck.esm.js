...
import { fetchSharedAccessQuery, urlSearchParamPreviewPerspective, urlSearchParamVercelProtectionBypass, urlSearchParamVercelSetBypassCookie, schemaTypeSingleton, schemaIdSingleton, schemaType } from "@sanity/preview-url-secret/constants";
...
import { Button, ErrorBoundary, Tooltip, MenuButton, MenuItem, TooltipDelayGroupProvider } from "./TooltipDelayGroupProvider.esm.js";
import "../_singletons.esm.js";
import { DisplayedDocumentBroadcasterProvider } from "./DisplayedDocumentBroadcaster.esm.js";
import { v4 } from "uuid";
...
const PostMessageFeatures = (props) => {
  ...
  let t0, t1;
  return $[0] !== comlink ? (t0 = () => comlink.on("visual-editing/features", _temp$9), t1 = [comlink], $[0] = comlink, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), useEffect(t0, t1), null;
};
...
function _temp2$4(panels) {
  ...
  return Array.isArray(stored[key]) && stored[key].some(_temp$8) ? void 0 : stored[key];
}
function _temp$8(val) {
  return val === null;
}
...
function DocumentListPane(props) {
  ...
  if ($[0] !== mainDocumentState?.document?._id || $[1] !== refs) {
    let t22;
    $[3] !== mainDocumentState?.document?._id ? (t22 = (r) => getPublishedId(r._id) !== mainDocumentState?.document?._id, $[3] = mainDocumentState?.document?._id, $[4] = t22) : t22 = $[4], t1 = refs.filter(t22).map(_temp$6), $[0] = mainDocumentState?.document?._id, $[1] = refs, $[2] = t1;
  } else
    t1 = $[2];
  t0 = t1;
  const ids = t0;
  ...
  const handleRetry = t6, [structureParams] = useState(_temp2$2);
  let t7;
...
function DocumentPanel(props) {
  ...
  let t0;
  return $[0] !== documentId || $[1] !== documentType || $[2] !== onFocusPath || $[3] !== onStructureParams || $[4] !== searchParams || $[5] !== structureParams ? (t0 = /* @__PURE__ */ jsx(StructureToolProvider, { children: /* @__PURE__ */ jsx(DocumentPane, { documentId, documentType, onFocusPath, onStructureParams, searchParams, structureParams }) }), $[0] = documentId, $[1] = documentType, $[2] = onFocusPath, $[3] = onStructureParams, $[4] = searchParams, $[5] = structureParams, $[6] = t0) : t0 = $[6], t0;
}
function usePreviewState(documentId, schemaType2) {
  const $ = c(6), documentPreviewStore = useDocumentPreviewStore();
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = {}, $[0] = t0) : t0 = $[0];
  const [preview, setPreview] = useState(t0);
  let t1, t2;
  return $[1] !== documentId || $[2] !== documentPreviewStore || $[3] !== schemaType2 ? (t1 = () => {
    if (!schemaType2)
      return;
    const subscription = getPreviewStateObservable(documentPreviewStore, schemaType2, documentId).subscribe((state) => {
      setPreview(state);
    });
    return () => {
      subscription?.unsubscribe();
    };
  }, t2 = [documentPreviewStore, schemaType2, documentId], $[1] = documentId, $[2] = documentPreviewStore, $[3] = schemaType2, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), useEffect(t1, t2), preview;
}
...
function usePresentationNavigator(props) {
  ...
  bb0: {
    ...
    let t12;
    $[0] !== setNavigatorEnabled ? (t12 = () => setNavigatorEnabled(_temp$5), $[0] = setNavigatorEnabled, $[1] = t12) : t12 = $[1], t0 = t12;
  }
...
function OpenPreviewButton(props) {
  ...
  let t6;
  $[9] !== handleOpenPopup || $[10] !== t4 || $[11] !== t5 ? (t6 = /* @__PURE__ */ jsx(Button, { as: "a", "aria-label": t4, icon: LaunchIcon, mode: "bleed", href: t5, rel: "opener", target: "_blank", tooltipProps: null, onClick: handleOpenPopup }), $[9] = handleOpenPopup, $[10] = t4, $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  return $[13] !== t2 || $[14] !== t6 ? (t7 = /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t2, fallbackPlacements: t3, placement: "bottom", portal: !0, children: t6 }), $[13] = t2, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
...
}, QRCodeSVG = lazy(() => import("./QRCodeSVG.esm.js")), QrCodeLogoSize = 24, QrCodeLogoPadding = 16, QrSize = 224, StyledSanityMonogram = styled(SanityMonogram)`
  position: absolute;
  top: 50%;
  left: 50%;
...
const PreviewHeaderDefault = (props) => {
  ...
  let t32;
  $[59] !== openPopup || $[60] !== previewLocationOrigin || $[61] !== previewLocationRoute ? (t32 = /* @__PURE__ */ jsx(Box, { padding: 1, children: /* @__PURE__ */ jsx(OpenPreviewButton, { openPopup, previewLocationOrigin, previewLocationRoute }) }), $[59] = openPopup, $[60] = previewLocationOrigin, $[61] = previewLocationRoute, $[62] = t32) : t32 = $[62];
  let t33;
  $[63] !== onPathChange || $[64] !== previewLocationOrigin || $[65] !== previewLocationRoute || $[66] !== t31 || $[67] !== t32 ? (t33 = /* @__PURE__ */ jsx(Box, { flex: 1, children: /* @__PURE__ */ jsx(PreviewLocationInput, { prefix: t31, onChange: onPathChange, origin: previewLocationOrigin, suffix: t32, value: previewLocationRoute }) }), $[63] = onPathChange, $[64] = previewLocationOrigin, $[65] = previewLocationRoute, $[66] = t31, $[67] = t32, $[68] = t33) : t33 = $[68];
  const t34 = viewport === "desktop" ? "narrow" : "full";
  let t35;
  $[69] !== t || $[70] !== t34 ? (t35 = t("preview-frame.viewport-button.tooltip", {
    context: t34
  }), $[69] = t, $[70] = t34, $[71] = t35) : t35 = $[71];
  let t36;
  $[72] !== t35 ? (t36 = /* @__PURE__ */ jsx(Text, { size: 1, children: t35 }), $[72] = t35, $[73] = t36) : t36 = $[73];
  let t37;
  $[74] === Symbol.for("react.memo_cache_sentinel") ? (t37 = ["bottom-start"], $[74] = t37) : t37 = $[74];
  let t38;
  $[75] !== t ? (t38 = t("preview-frame.viewport-button.aria-label"), $[75] = t, $[76] = t38) : t38 = $[76];
  const t39 = viewport === "desktop" ? MobileDeviceIcon : DesktopIcon;
  let t40;
  $[77] !== t38 || $[78] !== t39 || $[79] !== toggleViewportSize ? (t40 = /* @__PURE__ */ jsx(Button, { "aria-label": t38, icon: t39, mode: "bleed", onClick: toggleViewportSize, tooltipProps: null }), $[77] = t38, $[78] = t39, $[79] = toggleViewportSize, $[80] = t40) : t40 = $[80];
  let t41;
  $[81] !== t36 || $[82] !== t40 ? (t41 = /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t36, fallbackPlacements: t37, placement: "bottom", portal: !0, children: t40 }) }), $[81] = t36, $[82] = t40, $[83] = t41) : t41 = $[83];
  let t42;
  $[84] !== canSharePreviewAccess || $[85] !== canToggleSharePreviewAccess || $[86] !== canUseSharedPreviewAccess || $[87] !== initialUrl || $[88] !== perspective || $[89] !== previewLocationRoute ? (t42 = canSharePreviewAccess && /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective }) }), $[84] = canSharePreviewAccess, $[85] = canToggleSharePreviewAccess, $[86] = canUseSharedPreviewAccess, $[87] = initialUrl, $[88] = perspective, $[89] = previewLocationRoute, $[90] = t42) : t42 = $[90];
  let t43;
  return $[91] !== t24 || $[92] !== t33 || $[93] !== t41 || $[94] !== t42 || $[95] !== t6 ? (t43 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 1, paddingX: 1, style: t5, children: [
    t6,
    t24,
    t33,
    t41,
    t42
  ] }), $[91] = t24, $[92] = t33, $[93] = t41, $[94] = t42, $[95] = t6, $[96] = t43) : t43 = $[96], t43;
};
function PreviewHeader(props) {
  const $ = c(7), renderDefault = _temp$4, HeaderComponent = props.options?.component;
  let t0;
...
function useDocumentsOnPage(perspective, frameStateRef) {
  ...
  const [published, setPublished] = useState({}), [previewDrafts, setPreviewDrafts] = useState({}), urlRef = useRef(""), setDocumentsOnPage = useCallback(
    ...
    (key, perspective_0, sourceDocuments = []) => {
...
function useMainDocument(props) {
  ...
  let t5;
  $[9] !== client || $[10] !== handleResponse || $[11] !== previewUrl || $[12] !== relativeUrl || $[13] !== resolvers ? (t5 = () => {
  ...
  }, $[9] = client, $[10] = handleResponse, $[11] = previewUrl, $[12] = relativeUrl, $[13] = resolvers, $[14] = t5) : t5 = $[14];
  let t6;
  return $[15] !== client || $[16] !== previewUrl || $[17] !== relativeUrl || $[18] !== resolvers ? (t6 = [client, previewUrl, relativeUrl, resolvers], $[15] = client, $[16] = previewUrl, $[17] = relativeUrl, $[18] = resolvers, $[19] = t6) : t6 = $[19], useEffect(t5, t6), mainDocumentState;
}
function _temp$3(t0) {
  const [key] = t0;
  return key === "preview";
...
function usePreviewUrl(previewUrl, toolName, studioPreviewPerspective, previewSearchParam, canCreateUrlPreviewSecrets) {
  const client = useClient({
    apiVersion: API_VERSION
  }), workspace = useActiveWorkspace(), basePath = workspace?.activeWorkspace?.basePath || "/", workspaceName = workspace?.activeWorkspace?.name || "default", deps = useSuspendCacheKeys(toolName, basePath, workspaceName, previewSearchParam), previewUrlSecret = usePreviewUrlSecret(canCreateUrlPreviewSecrets && typeof previewUrl == "object" || typeof previewUrl == "function", deps);
...
const LiveQueries = lazy(() => import("./LiveQueries.esm.js")), PostMessageDocuments = lazy(() => import("./PostMessageDocuments.esm.js")), PostMessageRefreshMutations = lazy(() => import("./PostMessageRefreshMutations.esm.js")), PostMessagePerspective = lazy(() => import("./PostMessagePerspective.esm.js")), PostMessagePreviewSnapshots = lazy(() => import("./PostMessagePreviewSnapshots.esm.js")), PostMessageSchema = lazy(() => import("./PostMessageSchema.esm.js")), PostMessageTelemetry = lazy(() => import("./PostMessageTelemetry.esm.js")), Container = styled(Flex)`
  overflow-x: auto;
`;
function PresentationTool(props) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PresentationProvider, { devMode, name, navigate, params, searchParams, structureParams, children: /* @__PURE__ */ jsx(PresentationNavigateProvider, { navigate, children: /* @__PURE__ */ jsx(PresentationParamsProvider, { params, children: /* @__PURE__ */ jsx(SharedStateProvider, { comlink: visualEditingComlink, children: /* @__PURE__ */ jsx(Container, { height: "fill", children: /* @__PURE__ */ jsxs(Panels, { children: [
...
//# sourceMappingURL=PresentationToolGrantsCheck.esm.js.map
