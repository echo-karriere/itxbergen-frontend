import { Tooltip, TooltipDelayGroupProvider, Button, Dialog, ErrorBoundary, MenuItem, MenuButton, Tab, Popover as Popover$1 } from "./TooltipDelayGroupProvider.mjs";
...
import { MenuGroup, generateHelpUrl } from "./generate-help-url.esm.mjs";
...
const structureLocaleNamespace = "structure", structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources5.mjs")
});
