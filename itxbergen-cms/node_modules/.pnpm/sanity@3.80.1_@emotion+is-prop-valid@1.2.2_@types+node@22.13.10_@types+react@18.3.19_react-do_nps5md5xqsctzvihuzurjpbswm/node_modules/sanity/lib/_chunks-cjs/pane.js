...
function DocTitle(props) {
  ...
  const schemaType = t0, {
    t
  } = sanity.useTranslation(structureLocaleNamespace);
  let t1;
...
`, OtherReferenceCount = (props) => {
  const $ = reactCompilerRuntime.c(13), {
    t
  } = sanity.useTranslation(structureLocaleNamespace), difference = props.totalCount - props.references.length;
  if (!difference)
    return null;
  let t0;
...
function ConfirmDeleteDialog(t0) {
  const $ = reactCompilerRuntime.c(40), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), dialogId = `deletion-confirmation-${React.useId()}`, {
    internalReferences,
    crossDatasetReferences,
    isLoading,
    totalCount,
...
function ConfirmDeleteDialogContainer(props) {
  const $ = reactCompilerRuntime.c(6), {
    t
  } = sanity.useTranslation(structureLocaleNamespace), id = React.useId(), [error, setError] = React.useState(null);
  let t0;
...
const IntentButton = React.forwardRef(function(props, ref) {
  ...
  let t0, t1;
  $[3] !== intent.params || $[4] !== intent.searchParams || $[5] !== intent.type ? (t1 = React.forwardRef(function(linkProps, linkRef) {
  ...
  }), $[3] = intent.params, $[4] = intent.searchParams, $[5] = intent.type, $[6] = t1) : t1 = $[6], t0 = t1;
  const Link2 = t0;
  let t2;
  return $[7] !== Link2 || $[8] !== props.disabled || $[9] !== ref || $[10] !== restProps ? (t2 = props.disabled ? /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...restProps, as: Link2, "data-as": "a", ref }), $[7] = Link2, $[8] = props.disabled, $[9] = ref, $[10] = restProps, $[11] = t2) : t2 = $[11], t2;
});
...
const RenderActionCollectionState = React.memo((props) => {
  ...
  let t0;
  return $[0] !== actionProps || $[1] !== actions || $[2] !== children || $[3] !== group || $[4] !== onActionComplete ? (t0 = /* @__PURE__ */ jsxRuntime.jsx(sanity.GetHookCollectionState, { onReset: onActionComplete, hooks: actions, args: actionProps, group, children }), $[0] = actionProps, $[1] = actions, $[2] = children, $[3] = group, $[4] = onActionComplete, $[5] = t0) : t0 = $[5], t0;
});
...
`, VersionModeHeader = ({
  ...
  const {
    ...
    t: tStructure
  } = sanity.useTranslation(structureLocaleNamespace), onClick = React.useCallback(() => {
    if (type === "draft") {
...
function useDocumentTitle() {
  const $ = reactCompilerRuntime.c(19), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), subscribed = !!displayed;
  let t0;
...
function InspectDialog(props) {
  ...
  const setRawViewMode = t2, {
    t
  } = sanity.useTranslation(structureLocaleNamespace), t3 = `${dialogIdPrefix}dialog`;
  let t4;
...
function RequestPermissionDialog(t0) {
  const $ = reactCompilerRuntime.c(56), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), telemtry = react.useTelemetry(), dialogId = `request-permissions-${React.useId()}`, projectId = sanity.useProjectId();
  let t1;
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = sanity.useListFormat(t3), {
    t
  } = sanity.useTranslation(structureLocaleNamespace), telemetry2 = react.useTelemetry();
  let roleTitles, t4;
...
const ReferenceChangedBanner = React.memo(() => {
  const documentPreviewStore = sanity.useDocumentPreviewStore(), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), referenceInfoObservable = React.useMemo(() => {
...
function AddToReleaseBanner(t0) {
  ...
  let t3;
  $[2] !== createVersion || $[3] !== currentRelease._id || $[4] !== documentId || $[5] !== t || $[6] !== toast || $[7] !== value ? (t3 = async () => {
  ...
  }, $[2] = createVersion, $[3] = currentRelease._id, $[4] = documentId, $[5] = t, $[6] = toast, $[7] = value, $[8] = t3) : t3 = $[8];
  ...
  let t8;
  $[17] !== currentRelease.metadata?.title || $[18] !== tCore ? (t8 = currentRelease?.metadata?.title || tCore("release.placeholder-untitled-release"), $[17] = currentRelease.metadata?.title, $[18] = tCore, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== t8 ? (t9 = {
    title: t8
  }, $[20] = t8, $[21] = t9) : t9 = $[21];
  let t10;
  $[22] !== currentRelease ? (t10 = sanity.getVersionInlineBadge(currentRelease), $[22] = currentRelease, $[23] = t10) : t10 = $[23];
  let t11;
  $[24] !== t10 ? (t11 = {
    VersionBadge: t10
  }, $[24] = t10, $[25] = t11) : t11 = $[25];
  let t12;
  $[26] !== t || $[27] !== t11 || $[28] !== t9 ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { i18nKey: "banners.release.not-in-release", t, values: t9, components: t11 }) }), $[26] = t, $[27] = t11, $[28] = t9, $[29] = t12) : t12 = $[29];
  let t13;
  $[30] !== t ? (t13 = t("banners.release.action.add-to-release"), $[30] = t, $[31] = t13) : t13 = $[31];
  const t14 = !!versionCreateState;
  let t15;
  $[32] !== handleAddToRelease || $[33] !== t13 || $[34] !== t14 || $[35] !== tone ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { gap: 2, align: "center", justify: "center", children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { text: t13, tone, disabled: t14, onClick: handleAddToRelease }) }), $[32] = handleAddToRelease, $[33] = t13, $[34] = t14, $[35] = tone, $[36] = t15) : t15 = $[36];
  let t16;
  $[37] !== t12 || $[38] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: [
    t12,
    t15
  ] }), $[37] = t12, $[38] = t15, $[39] = t16) : t16 = $[39];
  let t17;
  return $[40] !== t16 || $[41] !== tone ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone, paddingY: 0, content: t16 }), $[40] = t16, $[41] = tone, $[42] = t17) : t17 = $[42], t17;
}
...
function ArchivedReleaseDocumentBanner() {
  const {
    ...
    params,
    setParams
  } = structure.usePaneRouter(), handleGoBack = () => {
    setParams({
      ...params,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone: "caution", paddingY: 2, content: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { t, i18nKey: description, values: {
    title
  }, components: {
...
function DraftLiveEditBanner(t0) {
  const $ = reactCompilerRuntime.c(38), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), [isPublishing, setPublishing] = React.useState(!1), [isDiscarding, setDiscarding] = React.useState(!1), telemetry2 = react.useTelemetry(), {
    publish,
    discardChanges
...
function OpenReleaseToEditBannerInner({
  ...
  const {
    ...
    t
  } = sanity.useTranslation(structure.structureLocaleNamespace), handleGoToEdit = React.useCallback(async () => {
...
function ScheduledReleaseBanner(t0) {
  ...
  let t3;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(icons.LockIcon, {}), $[2] = t3) : t3 = $[2];
  let t4;
  $[3] !== currentRelease ? (t4 = sanity.formatRelativeLocalePublishDate(currentRelease), $[3] = currentRelease, $[4] = t4) : t4 = $[4];
  let t5;
  $[5] !== t4 ? (t5 = {
    date: t4
  }, $[5] = t4, $[6] = t5) : t5 = $[6];
  let t6;
  $[7] !== t5 || $[8] !== tCore ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "center", gap: 2, children: [
    t3,
    " ",
    /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { t: tCore, i18nKey: "release.banner.scheduled-for-publishing-on", values: t5 })
  ] }) }) }), $[7] = t5, $[8] = tCore, $[9] = t6) : t6 = $[9];
  let t7;
  return $[10] !== t6 || $[11] !== tone ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone, paddingY: 0, content: t6 }), $[10] = t6, $[11] = tone, $[12] = t7) : t7 = $[12], t7;
}
...
`, FormHeader = (t0) => {
  const $ = reactCompilerRuntime.c(13), {
    ...
    t
  } = reactI18next.useTranslation(structureLocaleNamespace);
  if (schemaType.__experimental_formPreviewTitle === !1)
    return null;
  let t1;
  $[0] !== isSingleton || $[1] !== schemaType.name || $[2] !== schemaType.title ? (t1 = !isSingleton && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { muted: !0, size: 1, children: schemaType.title ?? schemaType.name }), $[0] = isSingleton, $[1] = schemaType.name, $[2] = schemaType.title, $[3] = t1) : t1 = $[3];
  const t2 = !title;
  let t3;
  $[4] !== t || $[5] !== title ? (t3 = title ?? t("document-view.form-view.form-title-fallback"), $[4] = t, $[5] = title, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t2 || $[8] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { as: "h2", "data-heading": !0, muted: t2, "data-testid": "document-panel-document-title", children: t3 }), $[7] = t2, $[8] = t3, $[9] = t4) : t4 = $[9];
  let t5;
  return $[10] !== t1 || $[11] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(TitleContainer, { marginBottom: 6, space: 4, children: [
    t1,
    t4
  ] }), $[10] = t1, $[11] = t4, $[12] = t5) : t5 = $[12], t5;
  ...
  $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== connectionState || $[43] !== documentId || $[44] !== editState?.draft || $[45] !== editState?.published || $[46] !== editState?.ready || $[47] !== fieldActions || $[48] !== formState || $[49] !== hidden || $[50] !== onBlur || $[51] !== onChange || $[52] !== onFocus || $[53] !== onPathOpen || $[54] !== onSetActiveFieldGroup || $[55] !== onSetCollapsedFieldSet || $[56] !== onSetCollapsedPath || $[57] !== openPath || $[58] !== patchChannel || $[59] !== presence || $[60] !== t || $[61] !== title || $[62] !== validation ? (t13 = connectionState === "connecting" && !editState?.draft && !editState?.published ? /* @__PURE__ */ jsxRuntime.jsx(Delay, { ms: 300, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(sanity.FormBuilder, { __internal_fieldActions: fieldActions, __internal_patchChannel: patchChannel, changed: formState.changed, collapsedFieldSets, collapsedPaths, focused: formState.focused, focusPath: formState.focusPath, groups: formState.groups, id: "root", members: formState.members, onChange, onFieldGroupSelect: onSetActiveFieldGroup, onPathBlur: onBlur, onPathFocus: onFocus, onPathOpen, onSetFieldSetCollapsed: onSetCollapsedFieldSet, onSetPathCollapsed: onSetCollapsedPath, openPath, presence, readOnly: connectionState === "reconnecting" || formState.readOnly || !editState?.ready, schemaType: formState.schemaType, validation, value: formState.value })
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = connectionState, $[43] = documentId, $[44] = editState?.draft, $[45] = editState?.published, $[46] = editState?.ready, $[47] = fieldActions, $[48] = formState, $[49] = hidden, $[50] = onBlur, $[51] = onChange, $[52] = onFocus, $[53] = onPathOpen, $[54] = onSetActiveFieldGroup, $[55] = onSetCollapsedFieldSet, $[56] = onSetCollapsedPath, $[57] = openPath, $[58] = patchChannel, $[59] = presence, $[60] = t, $[61] = title, $[62] = validation, $[63] = t13) : t13 = $[63];
  let t14;
  $[64] !== setRef || $[65] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: t13 }), $[64] = setRef, $[65] = t13, $[66] = t14) : t14 = $[66];
  let t15;
  $[67] !== margins || $[68] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: t14 }), $[67] = margins, $[68] = t14, $[69] = t15) : t15 = $[69];
  let t16;
  return $[70] !== hidden || $[71] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[70] = hidden, $[71] = t15, $[72] = t16) : t16 = $[72], t16;
});
...
const DocumentPanelSubHeader = React.memo(function() {
  const $ = reactCompilerRuntime.c(13), {
    ...
    index,
    BackLink: BackLink2
  } = usePaneRouter(), [parentRef, setParentRef] = React.useState(null), showTabs = views2.length > 1, {
    collapsed,
    isLast
  ...
  bb1: {
    ...
    if (sanity.isReleaseDocument(selectedPerspective) && sanity.isReleaseScheduledOrScheduling(selectedPerspective)) {
      const t133 = selectedPerspective;
      let t143;
      $[35] !== t133 ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledReleaseBanner, { currentRelease: t133 }), $[35] = t133, $[36] = t143) : t143 = $[36], t12 = t143;
      break bb1;
    }
    let t132;
    $[37] !== selectedPerspective ? (t132 = sanity.isSystemBundle(selectedPerspective), $[37] = selectedPerspective, $[38] = t132) : t132 = $[38];
    ...
    if (displayed?._id && sanity.getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish) {
      ...
      let t162;
      $[39] !== t143 || $[40] !== t153 || $[41] !== value._id ? (t162 = /* @__PURE__ */ jsxRuntime.jsx(AddToReleaseBanner, { documentId: value._id, currentRelease: t143, value: t153 }), $[39] = t143, $[40] = t153, $[41] = value._id, $[42] = t162) : t162 = $[42], t12 = t162;
      break bb1;
    }
    if (activeView.type === "form" && isLiveEdit && ready && editState?.draft?._id && !selectedReleaseId) {
      let t143;
      $[43] !== displayed || $[44] !== documentId || $[45] !== schemaType ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(DraftLiveEditBanner, { displayed, documentId, schemaType }), $[43] = displayed, $[44] = documentId, $[45] = schemaType, $[46] = t143) : t143 = $[46], t12 = t143;
      break bb1;
    }
    ...
    let t152;
    $[49] !== permissions?.granted || $[50] !== requiredPermission ? (t152 = !permissions?.granted && /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionBanner, { requiredPermission }), $[49] = permissions?.granted, $[50] = requiredPermission, $[51] = t152) : t152 = $[51];
    let t16, t17, t18, t19;
    $[52] === Symbol.for("react.memo_cache_sentinel") ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t17 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t18 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), t19 = /* @__PURE__ */ jsxRuntime.jsx(UnpublishedDocumentBanner, {}), $[52] = t16, $[53] = t17, $[54] = t18, $[55] = t19) : (t16 = $[52], t17 = $[53], t18 = $[54], t19 = $[55]);
    const t20 = displayed?._id ?? documentId;
    let t21;
    $[56] !== isPinnedDraftOrPublish || $[57] !== t20 ? (t21 = /* @__PURE__ */ jsxRuntime.jsx(OpenReleaseToEditBanner, { documentId: t20, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[56] = isPinnedDraftOrPublish, $[57] = t20, $[58] = t21) : t21 = $[58];
    let t22;
    $[59] !== t142 || $[60] !== t152 || $[61] !== t21 ? (t22 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t142,
      t152,
      t16,
      t17,
  ...
  let t13;
  $[63] !== activeViewNode || $[64] !== banners || $[65] !== documentScrollElement || $[66] !== footer || $[67] !== formViewHidden || $[68] !== inspectDialog || $[69] !== layoutCollapsed || $[70] !== margins || $[71] !== portalElement || $[72] !== showFormView ? (t13 = showFormView && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
  ...
  let t14;
  $[74] !== documentId || $[75] !== rootElement || $[76] !== schemaType || $[77] !== showInspector ? (t14 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[74] = documentId, $[75] = rootElement, $[76] = schemaType, $[77] = showInspector, $[78] = t14) : t14 = $[78];
  let t15;
  return $[79] !== t13 || $[80] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t13,
    t14
...
const DISABLED_REASON_KEY$2 = {
  ...
  let t2;
  $[4] !== discardChanges || $[5] !== onComplete ? (t2 = () => {
    discardChanges.execute(), onComplete();
  }, $[4] = discardChanges, $[5] = onComplete, $[6] = t2) : t2 = $[6];
  const handleConfirm = t2;
  let t3;
  ...
  const handle = t3;
  let t4, t5;
  $[8] !== handleConfirm || $[9] !== isConfirmDialogOpen || $[10] !== onComplete || $[11] !== t ? (t5 = isConfirmDialogOpen && {
    type: "confirm",
    tone: "critical",
    onCancel: onComplete,
    onConfirm: handleConfirm,
    message: t("action.discard-changes.confirm-dialog.confirm-discard-changes")
  }, $[8] = handleConfirm, $[9] = isConfirmDialogOpen, $[10] = onComplete, $[11] = t, $[12] = t5) : t5 = $[12], t4 = t5;
  const dialog = t4;
  let t6;
  $[13] !== currentUser || $[14] !== dialog || $[15] !== discardChanges.disabled || $[16] !== isPermissionsLoading || $[17] !== liveEdit || $[18] !== permissions?.granted || $[19] !== published || $[20] !== t ? (t6 = () => !published || liveEdit ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    ...
    onHandle: handle,
    dialog
  }, $[13] = currentUser, $[14] = dialog, $[15] = discardChanges.disabled, $[16] = isPermissionsLoading, $[17] = liveEdit, $[18] = permissions?.granted, $[19] = published, $[20] = t, $[21] = t6) : t6 = $[21];
  let t7;
  return $[22] !== t6 ? (t7 = t6(), $[22] = t6, $[23] = t7) : t7 = $[23], t7;
};
...
const DISABLED_REASON_KEY$1 = {
  ...
  const [permissions, isPermissionsLoading] = sanity.useDocumentPairPermissions(t1), {
    t
  } = sanity.useTranslation(structureLocaleNamespace), currentUser = sanity.useCurrentUser();
  let t2;
  $[4] !== documentStore.pair || $[5] !== duplicate || $[6] !== id || $[7] !== navigateIntent || $[8] !== onComplete || $[9] !== type ? (t2 = async () => {
    const dupeId = uuid.uuid();
    setDuplicating(!0);
    const duplicateSuccess = rxjs.firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(rxjs.filter(_temp$c)));
    duplicate.execute(dupeId), await duplicateSuccess, navigateIntent("edit", {
      id: dupeId,
      type
    }), onComplete();
  }, $[4] = documentStore.pair, $[5] = duplicate, $[6] = id, $[7] = navigateIntent, $[8] = onComplete, $[9] = type, $[10] = t2) : t2 = $[10];
  const handle = t2;
  let t3;
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
...
const DISABLED_REASON_KEY = {
  ...
  const {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), handleCancel = React.useCallback(() => {
    setConfirmDialogOpen(!1), onComplete();
  ...
  return React.useMemo(() => release || liveEdit ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    ...
    dialog
  }, [release, currentUser, dialog, isPermissionsLoading, liveEdit, permissions?.granted, t, unpublish.disabled]);
};
...
const DocumentStatusBarActionsInner = React.memo(function(props) {
  ...
  if (actions.length === 0 || !editState)
    return null;
  let t4;
  return $[8] !== actions || $[9] !== editState || $[10] !== renderDocumentStatusBarActions ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions, actionProps: editState, group: "default", children: renderDocumentStatusBarActions }), $[8] = actions, $[9] = editState, $[10] = renderDocumentStatusBarActions, $[11] = t4) : t4 = $[11], t4;
  ...
  let t8;
  return $[12] !== historyActions || $[13] !== renderDocumentStatusBarActions || $[14] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions: historyActions, actionProps: t7, group: "default", children: renderDocumentStatusBarActions }), $[12] = historyActions, $[13] = renderDocumentStatusBarActions, $[14] = t7, $[15] = t8) : t8 = $[15], t8;
});
...
const TooltipContent$1 = (t0) => {
  ...
  const {
    ...
    params,
    setParams
  } = structure.usePaneRouter(), dateTimeFormat = sanity.useDateTimeFormat(DATE_TIME_FORMAT), {
    loading
  ...
  const {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), renderPaneActions = React.useCallback(({
    states
    ...
    editState && /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions, actionProps: editState, group: "paneActions", children: renderPaneActions }),
  ...
  ] }), [BackLink2, actions, editState, menuButtonNodes, onPaneClose, onPaneSplit, renderPaneActions, schemaType, showPaneGroupCloseButton, showSplitPaneButton, showSplitPaneCloseButton, t, unstable_languageFilter]);
  return /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: collapsed ? /* @__PURE__ */ jsxRuntime.jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { hidden: collapsed, style: {
    ...
    /* @__PURE__ */ jsxRuntime.jsx(HorizontalScroller, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { flex: 1, gap: 1, overflow: "auto", paddingX: 3, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentPerspectiveList, {}) }) }),
...
`, Circle = (props) => /* @__PURE__ */ jsxRuntime.jsx(framerMotion.motion.circle, { fill: "none", r: "8", cx: "12.5", cy: "12.5", strokeWidth: "1.2", ...props }), Arrows = (props) => /* @__PURE__ */ jsxRuntime.jsx(StyledMotionPath, { fill: "none", d: "M14 17.5619L11.5 20.5L14.5 23.0619M11 7.43811L13.5 4.50001L10.5 1.93811", ...props }), Checkmark = (props) => /* @__PURE__ */ jsxRuntime.jsx(framerMotion.motion.path, { d: "M9.5 12.1316L11.7414 14.5L16 10", ...props }), rotateAnimation = styledComponents.keyframes`
  0% {
    transform: rotate(0);
  }
  100% {
...
function DocumentStatusBar(props) {
  const $ = reactCompilerRuntime.c(22), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = sanity.useSanityCreateConfig().components?.documentLinkedActions, showingRevision = !!revisionId, [collapsed, setCollapsed] = React.useState(null), [rootElement, setRootElement] = React.useState(null);
  let t0;
  ...
  bb0: {
    ...
    if (selectedPerspective) {
      if (sanity.isPublishedPerspective(selectedPerspective)) {
        t2 = isReady && !!editState?.published;
        break bb0;
      }
      if (sanity.isReleaseDocument(selectedPerspective)) {
        t2 = isReady && !!editState?.version;
        break bb0;
      }
    }
    t2 = isReady;
  ...
  if (createLinkMetadata && sanity.isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions) {
    let t32;
    $[3] !== CreateLinkedActions || $[4] !== createLinkMetadata || $[5] !== onDocumentChange || $[6] !== title ? (t32 = /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedActions, { metadata: createLinkMetadata, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT, onDocumentChange, documentTitle: title }), $[3] = CreateLinkedActions, $[4] = createLinkMetadata, $[5] = onDocumentChange, $[6] = title, $[7] = t32) : t32 = $[7], actions = t32;
  } else if (showingRevision) {
    let t32;
    $[8] === Symbol.for("react.memo_cache_sentinel") ? (t32 = /* @__PURE__ */ jsxRuntime.jsx(HistoryStatusBarActions, {}), $[8] = t32) : t32 = $[8], actions = t32;
  } else {
    let t32;
    $[9] === Symbol.for("react.memo_cache_sentinel") ? (t32 = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusBarActions, {}), $[9] = t32) : t32 = $[9], actions = t32;
  }
  ...
  let t7;
  $[12] !== actions || $[13] !== actionsBoxRef || $[14] !== collapsed || $[15] !== shouldRender || $[16] !== showingRevision ? (t7 = shouldRender && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "stretch", gap: 1, justify: "space-between", paddingLeft: showingRevision ? 0 : 1, paddingRight: showingRevision ? 0 : 1, children: [
  ...
  let t8;
  return $[18] !== t3 || $[19] !== t6 || $[20] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(AnimatedCard, { initial: t4, animate: t5, tone: t6, radius: 3, ref: setRootElement, sizing: "border", padding: 2, children: t7 }, t3), $[18] = t3, $[19] = t6, $[20] = t7, $[21] = t8) : t8 = $[21], t8;
}
const KeyboardShortcutResponder = React.memo(function(props) {
  ...
  if (!actionProps || !actions)
    return null;
  let t5;
  return $[14] !== actionProps || $[15] !== actions || $[16] !== renderDocumentActionShortcuts ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts }), $[14] = actionProps, $[15] = actions, $[16] = renderDocumentActionShortcuts, $[17] = t5) : t5 = $[17], t5;
});
...
function getCompareVersionsItem({
  ...
  const isDisabled = typeof documentIdStack?.previousId > "u";
...
function DocumentLayoutFooter(t0) {
  ...
  let t4;
  $[4] !== StartInCreateBanner || $[5] !== documentId || $[6] !== isInitialValueLoading || $[7] !== ready || $[8] !== schemaType || $[9] !== value ? (t4 = StartInCreateBanner && /* @__PURE__ */ jsxRuntime.jsx(ShowWhenPaneOpen, { children: /* @__PURE__ */ jsxRuntime.jsx(StartInCreateBanner, { document: value, documentId, documentType: schemaType, documentReady: ready, isInitialValueLoading: !!isInitialValueLoading, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT }) }), $[4] = StartInCreateBanner, $[5] = documentId, $[6] = isInitialValueLoading, $[7] = ready, $[8] = schemaType, $[9] = value, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== createLinkMetadata || $[12] !== setActionsBoxElement ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }), $[11] = createLinkMetadata, $[12] = setActionsBoxElement, $[13] = t5) : t5 = $[13];
  let t6;
  $[14] !== setFooterElement || $[15] !== t4 || $[16] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsxs(PaneFooter, { ref: setFooterElement, padding: 1, children: [
    t4,
    t5
  ] }), $[14] = setFooterElement, $[15] = t4, $[16] = t5, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== t6 || $[19] !== zOffsets.portal ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(ui.DialogProvider, { position: DIALOG_PROVIDER_POSITION$1, zOffset: zOffsets.portal, children: t6 }), $[18] = t6, $[19] = zOffsets.portal, $[20] = t7) : t7 = $[20];
  let t8;
  return $[21] !== portalElements || $[22] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(ui.PortalProvider, { __unstable_elements: portalElements, children: t7 }), $[21] = portalElements, $[22] = t7, $[23] = t8) : t8 = $[23], t8;
}
...
const DocumentPaneProvider = React.memo((props) => {
  const {
  ...
  }, [getIsDeleted, isDeleting, revisionId]), getDisplayed = React.useCallback((value) => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
    ...
    schemaType: documentType,
    documentId
  }), [documentId, documentType, languageFilterResolver]), views2 = sanity.useUnique(viewsProp), activeViewId = params.view || views2[0] && views2[0].id || null, previewUrl = usePreviewUrl(value_0), {
    t
  } = sanity.useTranslation(structureLocaleNamespace), fieldActions = React.useMemo(() => schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
...
function useDocumentSheetList({
  ...
  const {
    state: state2
  } = sanity.useSearchState(), items = React.useMemo(() => {
  ...
  return {
    data: React.useMemo(() => data.filter((doc) => items.has(sanity.getPublishedId(doc._id))), [data, items]),
    isLoading
  };
}
...
function PublishedEventMenu(t0) {
  const $ = reactCompilerRuntime.c(37), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), portalContext = ui.usePortal(), {
    params,
    setParams
  } = structure.usePaneRouter(), setPerspective = sanity.useSetPerspective();
  let t1;
...
function EventsSelector({
  ...
  const [scrollRef, setScrollRef] = React.useState(null), [listHeight, setListHeight] = React.useState(0), {
    setTimelineRange
  } = structure.useDocumentPane(), getScrollerRef = React.useCallback((el) => {
...
function ChangesTabs(props) {
  const $ = reactCompilerRuntime.c(54), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), isReady = params?.inspect === HISTORY_INSPECTOR_NAME;
  let t0;
...
function StructureToolProvider({
  ...
  }), [layoutCollapsed]), structureTool2 = React.useMemo(() => ({
    features,
    layoutCollapsed,
    setLayoutCollapsed,
    rootPaneNode,
