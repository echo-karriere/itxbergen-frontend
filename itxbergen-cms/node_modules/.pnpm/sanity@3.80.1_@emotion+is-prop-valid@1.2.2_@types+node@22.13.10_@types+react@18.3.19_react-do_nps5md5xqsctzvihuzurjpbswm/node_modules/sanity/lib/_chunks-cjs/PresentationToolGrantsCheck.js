...
const PostMessageFeatures = (props) => {
  ...
  let t0, t1;
  return $[0] !== comlink2 ? (t0 = () => comlink2.on("visual-editing/features", _temp$9), t1 = [comlink2], $[0] = comlink2, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), React.useEffect(t0, t1), null;
};
...
function DocumentListPane(props) {
  ...
  if ($[0] !== mainDocumentState?.document?._id || $[1] !== refs) {
    let t22;
    $[3] !== mainDocumentState?.document?._id ? (t22 = (r) => sanity.getPublishedId(r._id) !== mainDocumentState?.document?._id, $[3] = mainDocumentState?.document?._id, $[4] = t22) : t22 = $[4], t1 = refs.filter(t22).map(_temp$6), $[0] = mainDocumentState?.document?._id, $[1] = refs, $[2] = t1;
  } else
    t1 = $[2];
  t0 = t1;
  const ids = t0;
...
function OpenPreviewButton(props) {
  ...
  let t6;
  $[9] !== handleOpenPopup || $[10] !== t4 || $[11] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { as: "a", "aria-label": t4, icon: icons.LaunchIcon, mode: "bleed", href: t5, rel: "opener", target: "_blank", tooltipProps: null, onClick: handleOpenPopup }), $[9] = handleOpenPopup, $[10] = t4, $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  return $[13] !== t2 || $[14] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, content: t2, fallbackPlacements: t3, placement: "bottom", portal: !0, children: t6 }), $[13] = t2, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
...
const PreviewHeaderDefault = (props) => {
  ...
  let t32;
  $[59] !== openPopup || $[60] !== previewLocationOrigin || $[61] !== previewLocationRoute ? (t32 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 1, children: /* @__PURE__ */ jsxRuntime.jsx(OpenPreviewButton, { openPopup, previewLocationOrigin, previewLocationRoute }) }), $[59] = openPopup, $[60] = previewLocationOrigin, $[61] = previewLocationRoute, $[62] = t32) : t32 = $[62];
  let t33;
  $[63] !== onPathChange || $[64] !== previewLocationOrigin || $[65] !== previewLocationRoute || $[66] !== t31 || $[67] !== t32 ? (t33 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: 1, children: /* @__PURE__ */ jsxRuntime.jsx(PreviewLocationInput, { prefix: t31, onChange: onPathChange, origin: previewLocationOrigin, suffix: t32, value: previewLocationRoute }) }), $[63] = onPathChange, $[64] = previewLocationOrigin, $[65] = previewLocationRoute, $[66] = t31, $[67] = t32, $[68] = t33) : t33 = $[68];
  ...
  let t36;
  $[72] !== t35 ? (t36 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: t35 }), $[72] = t35, $[73] = t36) : t36 = $[73];
  let t37;
  ...
  let t40;
  $[77] !== t38 || $[78] !== t39 || $[79] !== toggleViewportSize ? (t40 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t38, icon: t39, mode: "bleed", onClick: toggleViewportSize, tooltipProps: null }), $[77] = t38, $[78] = t39, $[79] = toggleViewportSize, $[80] = t40) : t40 = $[80];
  let t41;
  $[81] !== t36 || $[82] !== t40 ? (t41 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, content: t36, fallbackPlacements: t37, placement: "bottom", portal: !0, children: t40 }) }), $[81] = t36, $[82] = t40, $[83] = t41) : t41 = $[83];
  let t42;
  $[84] !== canSharePreviewAccess || $[85] !== canToggleSharePreviewAccess || $[86] !== canUseSharedPreviewAccess || $[87] !== initialUrl || $[88] !== perspective || $[89] !== previewLocationRoute ? (t42 = canSharePreviewAccess && /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective }) }), $[84] = canSharePreviewAccess, $[85] = canToggleSharePreviewAccess, $[86] = canUseSharedPreviewAccess, $[87] = initialUrl, $[88] = perspective, $[89] = previewLocationRoute, $[90] = t42) : t42 = $[90];
  let t43;
  return $[91] !== t24 || $[92] !== t33 || $[93] !== t41 || $[94] !== t42 || $[95] !== t6 ? (t43 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 1, paddingX: 1, style: t5, children: [
    t6,
    t24,
    t33,
    t41,
...
function PreviewHeader(props) {
  const $ = reactCompilerRuntime.c(7), renderDefault = _temp$4, HeaderComponent = props.options?.component;
  let t0;
...
function useMainDocument(props) {
  ...
  let t5;
  $[9] !== client2 || $[10] !== handleResponse || $[11] !== previewUrl || $[12] !== relativeUrl || $[13] !== resolvers ? (t5 = () => {
  ...
  }, $[9] = client2, $[10] = handleResponse, $[11] = previewUrl, $[12] = relativeUrl, $[13] = resolvers, $[14] = t5) : t5 = $[14];
  let t6;
  return $[15] !== client2 || $[16] !== previewUrl || $[17] !== relativeUrl || $[18] !== resolvers ? (t6 = [client2, previewUrl, relativeUrl, resolvers], $[15] = client2, $[16] = previewUrl, $[17] = relativeUrl, $[18] = resolvers, $[19] = t6) : t6 = $[19], React.useEffect(t5, t6), mainDocumentState;
}
function _temp$3(t0) {
  const [key] = t0;
  return key === "preview";
...
function usePreviewUrl(previewUrl, toolName, studioPreviewPerspective, previewSearchParam, canCreateUrlPreviewSecrets) {
  const client2 = sanity.useClient({
    apiVersion: presentation.API_VERSION
