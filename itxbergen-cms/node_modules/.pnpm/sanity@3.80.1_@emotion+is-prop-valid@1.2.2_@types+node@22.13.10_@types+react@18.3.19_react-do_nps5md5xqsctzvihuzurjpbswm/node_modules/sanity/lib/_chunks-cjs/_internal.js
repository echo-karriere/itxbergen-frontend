...
const debug = debug__default.default("sanity:backup"), DEFAULT_DOWNLOAD_CONCURRENCY = 10, MAX_DOWNLOAD_CONCURRENCY = 24, helpText$y = `
Options
...
}, DEFAULT_LIST_BACKUP_LIMIT = 30, helpText$w = `
Options
...
const yellow = (str) => `\x1B[33m${str}\x1B[39m`, helpText$m = `
Options
...
function determineIsApp(cliConfig) {
  return !!(cliConfig && "__experimental_appConfiguration" in cliConfig);
}
const helpText$l = `
Options
  --source-maps Enable source maps for built bundles (increases size of bundle)
...
}, defaultApiVersion = "v2022-06-01", helpText$f = `
...
const description$3 = "Downloads and validates all document specified in a workspace", helpText$e = `
Options
...
}, description$2 = "Extracts the studio configuration as one or more JSON manifest files.", helpText$9 = `
...
const MIGRATIONS_DIRECTORY = "migrations", MIGRATION_SCRIPT_EXTENSIONS = ["mjs", "js", "ts", "cjs"], DEFAULT_API_VERSION = "v2024-01-29", minimalAdvanced = ({
  migrationName,
  documentTypes
