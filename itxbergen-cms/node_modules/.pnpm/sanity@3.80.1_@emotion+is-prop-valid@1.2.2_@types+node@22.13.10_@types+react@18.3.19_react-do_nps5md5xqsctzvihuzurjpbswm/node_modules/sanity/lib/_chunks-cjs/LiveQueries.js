...
function LiveQueries(props) {
  ...
  const client = t3;
  let t5, t6;
  $[12] !== activePerspective || $[13] !== comlink$1 || $[14] !== dataset || $[15] !== projectId ? (t5 = () => {
    comlink$1 && comlink$1.post("loader/perspective", {
      projectId,
      dataset,
      perspective: activePerspective
    });
  }, t6 = [comlink$1, activePerspective, projectId, dataset], $[12] = activePerspective, $[13] = comlink$1, $[14] = dataset, $[15] = projectId, $[16] = t5, $[17] = t6) : (t5 = $[16], t6 = $[17]), React.useEffect(t5, t6);
  ...
  let t8;
  return $[20] !== client || $[21] !== comlink$1 || $[22] !== dataset || $[23] !== liveDocument || $[24] !== liveEvents.messages || $[25] !== liveEvents.resets || $[26] !== projectId || $[27] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: t7.map((t9) => {
    const [key, t10] = t9, {
      query,
      params,
      perspective
  ...
  }) }), $[20] = client, $[21] = comlink$1, $[22] = dataset, $[23] = liveDocument, $[24] = liveEvents.messages, $[25] = liveEvents.resets, $[26] = projectId, $[27] = t7, $[28] = t8) : t8 = $[28], t8;
}
function _temp() {
}
