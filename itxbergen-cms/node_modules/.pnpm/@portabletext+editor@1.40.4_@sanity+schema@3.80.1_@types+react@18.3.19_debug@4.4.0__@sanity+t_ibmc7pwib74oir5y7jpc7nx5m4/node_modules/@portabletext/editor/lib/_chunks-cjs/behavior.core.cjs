...
const addAnnotationOnCollapsedSelection = {
  ...
  guard: ({
    ...
    if (!isHotkey("ArrowDown", event.originEvent) || !selector_isAtTheStartOfBlock.isSelectionCollapsed(snapshot))
      return !1;
  ...
  guard: ({
    ...
    if (!isHotkey("ArrowUp", event.originEvent) || !selector_isAtTheStartOfBlock.isSelectionCollapsed(snapshot))
      return !1;
